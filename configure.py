...
if __name__=="__main__":
    ...
    parser=ArgumentParser(description="Configure GLWidget module.")
    parser.add_argument(
        '-q', '--qmake',
        dest="qmake",
        type=str,
    ...
    makefile.extra_defines+=['GLWIDGET_LIBRARY','QT_CORE_LIB', 'QT_GUI_LIB', 'QT_WIDGETS_LIB']
